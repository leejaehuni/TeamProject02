...
/*깃허브수정*/
public class BeforePayment {
	
	public String purchaserPaymentCode;
	public String goodsRefurbCode;
	public String memberId;
	public String beforeMidSumCode;
	public int beforeGoodsCount;
	public int midSumPrice;
	public String deliveryPostnumAddr;
	...
	public String toString() {
		...
		builder.append("BeforePayment [purchaserPaymentCode=");
