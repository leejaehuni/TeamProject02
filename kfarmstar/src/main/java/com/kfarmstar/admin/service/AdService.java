...
public class AdService {
	...
	public int adPayComplete(AdApply adApply, String sessionId) {
		log.info("sessionId {}" , sessionId);
		adApply.setManagerId(sessionId);
		return adMapper.adPayComplete(adApply);
	}
	...
	// 광고 결제 처리
	public int addAdPayment(String sessionId, AfterAdPay afterAdPay, AdPayType adPayType) {
