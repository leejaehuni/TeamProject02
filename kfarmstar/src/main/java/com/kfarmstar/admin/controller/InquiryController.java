...
private static final Logger log = LoggerFactory.getLogger(DeliveryController.class);
	...
	public String addInquiry(Model model) {
		...
		model.addAttribute("title", "FoodRefurb : 문의 내역 등록");
		model.addAttribute("titleName", "문의 내역 등록");
		model.addAttribute("titleMenu", "문의 관리");
	...
	public String addAnswer(Model model) {
		...
		log.info("문의 답변 내역 등록");
		
		model.addAttribute("title", "FoodRefurb : 답변  내역 등록");
		model.addAttribute("titleName", "답변 내역 등록");
		model.addAttribute("titleMenu", "문의 관리");
		
		return "inquiry/addAnswer";
	}
